...
var gradX = function(id, _options) {
    ...
    gradx = {
            ...
            if (this.targets.length > 0) {
                ...
                for (i = 0; i < len; i++) {
                    ...
                    for (j = 0; j < v_len; j++) {
                        ...
                        if (values[j].length < 20){
                            ele.css("background", values[j]);
        ...
        add_slider: function(sliders) {
            ...
            if (sliders.length === 0) {
                var current_color = $(".moodboard_canvas").css("background-image");
                ...
                if (current_color == "none") {
                    ...
                    var current_color_str = current_color.split(/\(|,|\)/);

                    if (current_color_str.length <= 14) {
                        var color_1 = "rgb(".concat(current_color_str[current_color_str.length-10], ",", current_color_str[current_color_str.length-9], ",", current_color_str[current_color_str.length-8], ")");
                        var pos_1 = current_color_str[current_color_str.length-7];
                        var color_2 = "rgb(".concat(current_color_str[current_color_str.length-5], ",", current_color_str[current_color_str.length-4], ",", current_color_str[current_color_str.length-3], ")");
                        var pos_2 = current_color_str[current_color_str.length-2];


                        sliders = [//set sliders
                            {
                                color: color_1,
                                position: pos_1.slice(0, pos_1.length - 1)
                            },
                            {
                                color: color_2,
                                position: pos_2.slice(0, pos_2.length - 1)
                            }
                        ];

                    }
                    else if (current_color_str.length <= 19) {
                        var color_1 = "rgb(".concat(current_color_str[current_color_str.length-15], ",", current_color_str[current_color_str.length-14], ",", current_color_str[current_color_str.length-13],")");
                        var pos_1 = current_color_str[current_color_str.length-12];
                        var color_2 = "rgb(".concat(current_color_str[current_color_str.length-10], ",", current_color_str[current_color_str.length-9], ",", current_color_str[current_color_str.length-8], ")");
                        var pos_2 = current_color_str[current_color_str.length-7];
                        var color_3 = "rgb(".concat(current_color_str[current_color_str.length-5], ",", current_color_str[current_color_str.length-4], ",", current_color_str[current_color_str.length-3], ")");
                        var pos_3 = current_color_str[current_color_str.length-2];
                        ...
                        sliders = [//set sliders
                            ...
                            {
                                color: color_3,
                                position: pos_3.slice(0, pos_3.length - 1)
                            }
                        ];
                    }
                    else if (current_color_str.length <= 24) {
                        var color_1 = "rgb(".concat(current_color_str[current_color_str.length-20], ",", current_color_str[current_color_str.length-19], ",", current_color_str[current_color_str.length-18], ")");
                        var pos_1 = current_color_str[current_color_str.length-17];
                        var color_2 = "rgb(".concat(current_color_str[current_color_str.length-15], ",", current_color_str[current_color_str.length-14], ",", current_color_str[current_color_str.length-13], ")");
                        var pos_2 = current_color_str[current_color_str.length-12];
                        var color_3 = "rgb(".concat(current_color_str[current_color_str.length-10], ",", current_color_str[current_color_str.length-9], ",", current_color_str[current_color_str.length-8], ")");
                        var pos_3 = current_color_str[current_color_str.length-7];
                        var color_4 = "rgb(".concat(current_color_str[current_color_str.length-5], ",", current_color_str[current_color_str.length-4], ",", current_color_str[current_color_str.length-3], ")");
                        var pos_4 = current_color_str[current_color_str.length-2];
                        ...
                        sliders = [//set sliders
                            ...
                            {
                                color: color_4,
                                position: pos_4.slice(0, pos_4.length - 1)

                            }];
                    }
                    else {
                        var color_1 = "rgb(".concat(current_color_str[current_color_str.length-25], ",", current_color_str[current_color_str.length-24], ",", current_color_str[current_color_str.length-23], ")");
                        var pos_1 = current_color_str[current_color_str.length-22];
                        var color_2 = "rgb(".concat(current_color_str[current_color_str.length-20], ",", current_color_str[current_color_str.length-19], ",", current_color_str[current_color_str.length-18], ")");
                        var pos_2 = current_color_str[current_color_str.length-17];
                        var color_3 = "rgb(".concat(current_color_str[current_color_str.length-15], ",", current_color_str[current_color_str.length-14], ",", current_color_str[current_color_str.length-13], ")");
                        var pos_3 = current_color_str[current_color_str.length-12];
                        var color_4 = "rgb(".concat(current_color_str[current_color_str.length-10], ",", current_color_str[current_color_str.length-9], ",", current_color_str[current_color_str.length-8], ")");
                        var pos_4 = current_color_str[current_color_str.length-7];
                        var color_5 = "rgb(".concat(current_color_str[current_color_str.length-5], ",", current_color_str[current_color_str.length-4], ",", current_color_str[current_color_str.length-3], ")");
                        var pos_5 = current_color_str[current_color_str.length-2];
                        ...
                        sliders = [//set sliders
                            ...
                            {
                                color: color_5,
                                position: pos_5.slice(0, pos_5.length - 1)
        ...
        load_gradx: function(id, sliders) {
            ...
            var html = "<div class='gradx'>\n\
                        ...
                        <div class=\"gradx_container gradx_btn\" style='display:inline-block;'>\n\
                                <a onclick=\"discard_element()\" href=\"#\">\n\
                                <i class=\"far fa-times-circle\"></i></a>\n\
                                <span class=\"text_label\"> Close</span>\n\
                            </div>\n\
                    </div>";
...
//            if(!gradx.jQ_present){
            ...
            gradx.gx('#gradx_delete_slider').click(function() {
                ...
                gradx.update_style_array();
                //console.log("COLORS");
                //console.log(gradx.get_style_value());
